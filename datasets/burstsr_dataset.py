...
class BurstSRDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, burst_size=8, crop_sz=80, center_crop=False, random_flip=False, split='train', phase='train'):
        """
        args:
    ...
    def __getitem__(self, index):
        ...
        return burst, frame_gt, meta_info_burst, meta_info_gt, downsample_factor, target_size, burst_name
